...
load(url("https://github.com/LPulle/NHSE-Analytics/blob/master/shiny/amb_checker_all_folder/initialdata.rda?raw=true"))
...
weightedlookup <- read.csv("https://raw.githubusercontent.com/LPulle/NHSE-Analytics/master/shiny/amb_checker_all_folder/weightedlookup.csv")
meanlookup <- read.csv("https://raw.githubusercontent.com/LPulle/NHSE-Analytics/master/shiny/amb_checker_all_folder/meanlookup.csv")
summedlookup <- read.csv("https://raw.githubusercontent.com/LPulle/NHSE-Analytics/master/shiny/amb_checker_all_folder/summedlookup.csv")
...
server <- function(input, output, session) {
  ...
  processdata <- function(extract) {
    ...
    req(input$file1)
    amb <- read.csv(input$file1$datapath,
      header = input$header,
      sep = input$sep,
      quote = input$quote
    )
